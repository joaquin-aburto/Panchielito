...
<header>
    ...
    <ul>
        ...
        <li><a href="../Galeria/biscocho.php">BIZCOCHO</a></li>
...
<body>
   <h1 class="productos-disponibles-title">Productos Disponibles</h1>
    ...
    <script src="../controladoresPrincipales/consultaProductosGeneral.js"></script>
</body>

       <script src="../desProductos/DesProductos.js"></script>
